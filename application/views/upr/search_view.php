...
margin-left: 60px;
 ...
 .pa a:hover{
    ...
    <hr/>
        <h3 ><font color="red">Did you mean  :</font>  <font color="blue"><?php echo $key?> ?</font></h3><hr/>
       <div class="pa">
...
<tr><td>       
        ...
        <tr><td>
<iframe style="margin-left: 20px;" width="260" height="130" frameborder="0" allowfullscreen src="<?php echo $booklist[$i]->video; ?>" > </iframe><div style="margin-top: -30px; margin-left: 320px; font-weight: bold;"><?php echo $booklist[$i]->cate; ?></div><br><p style="margin-left: 20px; "> </td></tr><br>
</table>
