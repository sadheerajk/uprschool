...
<html>
    ...
    <title>User Record | Uprschool</title>
    ...
    <body>
    <div class="container">
        <h1 style="font-size:20pt">Admin Panel | Users Record Displayed</h1>
        <h3>User Data</h3>
        <br />
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            if(data.photo)
            {
                ...
                $('#photo-preview div').html('<img src="'+base_url+'profiles/'+data.photo+'" class="img-responsive">'); // show photo
