...
<html>
    ...
    <body>
    <div class="container">
        <h1 style="font-size:20pt">Uprschool | Expert Record</h1>
        <h3>Language Experts</h3>
        <br />
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i>New Expert</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('expertdata/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('expertdata/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            if(data.photo)
            {
                ...
                $('#photo-preview div').html('<img src="'+base_url+'experts/'+data.photo+'" class="img-responsive">'); // show photo
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('expertdata/ajax_add')?>";
    } else {
        url = "<?php echo site_url('expertdata/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('expertdata/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="emai" placeholder="Email" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
